  ...
  return (
    <section id="services" ref={containerRef} className="relative py-32 bg-black overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => {
            ...
            return (
              ...
              >
                <div className="h-full p-8 rounded-2xl bg-gradient-to-br from-white/5 to-white/[0.02] border border-white/10 hover:border-white/20 transition-all duration-300 backdrop-blur-sm">
                  {/* Icon */}
                  <motion.div
                  ...
                  {/* Hover Glow Effect */}
                  <div className={`absolute inset-0 rounded-2xl bg-gradient-to-br ${service.color} opacity-0 group-hover:opacity-10 transition-opacity duration-300 blur-xl`} />
                </div>
              </motion.div>
            );
          })}
        ...
        {/* Vertical Scrolling Stats Section */}
        <motion.div
          style={{ scale }}
          className="mt-32 p-12 rounded-3xl bg-gradient-to-br from-purple-900/30 to-pink-900/30 border border-white/10 backdrop-blur-sm"
        >
